...
[`docs/raw-api-reference.md`](raw-api-reference.md) covers `mina.raw`, the functions you call *into* the engine. This page covers the other direction: `mina.on_event`, the 20 points at which the engine calls into your Lua, and the event table your handler gets at each one.
