...
int main( int argc, char** argv )
{
    ...
    fprintf( f, "Every MinaModAPI function as it appears from Lua, under `mina.raw`. One Lua function per C "
                ...
                "rows and why the C column is worth keeping: any name here greps against upstream's own "
                "source.\n\n" );
    ...
    fprintf( f, "Conventions that apply to every function here:\n\n"
                ...
                "which is when engine objects disappear in bulk; using one after that raises a `stale` error "
                ...
                "- A struct parameter is one value's worth of numbers. Where a function also takes a "
